...
> New to GitHub pull requests or AWS CDK? These get you started:
> [GitHub: creating a pull request](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request),
> [AWS CDK getting started](https://docs.aws.amazon.com/cdk/v2/guide/getting_started.html),
> and the README's [Key concepts](README.md#key-concepts) glossary.

1. You are working against the latest source on the *main* branch.
2. You check existing open, and recently merged, pull requests to make sure
   someone else hasn't addressed the problem already.
3. You open an issue to discuss any significant work before investing time in a large change.
...
2. Modify the source; please focus on the specific change you are contributing.
   ...
   change.
3. Ensure local tests pass (`cdk synth`).
